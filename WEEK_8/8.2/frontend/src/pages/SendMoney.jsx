        ...
        <div className="h-full flex flex-col justify-center">
            <div
                ...
                <div class="space-y-4">
                    ...
                    <button class="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-gray-800 text-white hover:bg-green-500">
                        Initiate Transfer
                    </button>
                </div>
                </div>
